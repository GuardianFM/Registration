...
<html>
    ...
    <body>
        ...
        <div id="StaffHold" class="w3-container" >
            <h1>Staff On Hold</h1>
                            ...
                            <tr>
                                <td >
                                    <form method="post"  action="csv.php"  align="center" id="exportform">
                                        ...
                                        <input type="text" name="criteria" id="criteria3" value="" hidden/>  
    ...
    <script>
        $(document).ready(function () {
            ...
            LoadData('fetch-holdstaff', limit_holdstaff);
        ...
        function CSV() {
            ...
            document.getElementById('criteria3').value = "WHERE `active`='active' AND `agreement_status` ='Decline' AND `verify`='unverify'  AND contractor_id=1120 AND Date(`regdate`)>='" + from + "' AND Date(`regdate`)<='" + to + "'";

            if (limit_holdstaff != 'All') {
