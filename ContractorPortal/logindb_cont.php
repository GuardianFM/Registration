...
try {
    ...
    if (isset($_POST["login"])) {
        if (empty($_POST["username"]) || empty($_POST["password"])) {
            ...
            $query = "SELECT * FROM tbl_contractors WHERE shortname = :username AND password = :password";
            ...
            if ($count > 0) {
                ...
                window.open("index_contractor.php");</script>';
                    ...
                    <div class="wrap-login100 p-t-85 p-b-20">
                        <form class="login100-form validate-form" method="post">
                            <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Enter username">
                                ...
                                <span class="focus-input100" data-placeholder="Client Login"></span>
                            </div>
                            ...
                            <ul class="login-more p-t-190">
                                <li class="m-b-8">
                                    ...
                                    <a href="forgot_password_cont.php" class="txt2" style='color: #C03A1C;'>
                                        Username / Password?
                                    </a>
                                </li>
