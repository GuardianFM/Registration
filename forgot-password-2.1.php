                ...
                <div class="h_iframe">
                    ...
                    <div class="splash-container">
                        <div class="text-xs-center ">
                            <span class="m-t-2"> <p>Please enter your new password.</p></span>
                            <div class="card">
                                ...
                                <div class="form-group" >
                                    <input class="form-control form-control-lg" name="conf_password" id="conf_password" type="password" placeholder="Confirm Password" autocomplete="off">
                                </div>
                ...
                $(document).on('click', '#btn-submit', function () {
                   ...
                   if (password !== conf_password) {
                    ...
                    $.ajax({
                        ...
                        url: "forgot-password-2_db.php",
                        method: "POST",
                        data: {email: email, mode: 'Update', password: password, conf_password: conf_password},
                        dataType: "text",
                        success: function (data)
                        {
                            document.getElementById('message').innerHTML = data;
                            if(data=='Your password has been reset successfully. Please login to proceed further.'){
                                 document.getElementById('password').value='';
                                 document.getElementById('conf_password').value='';
                                 //window.location.href = 'index_V1.1.php';
                            }
                        }
